...
if __name__ == '__main__' and sys.argv[1] == '-r':
    ...
    coo_func: Callable[..., Tuple] = hammer_aitoff  # Projections (i.e. Mollweide, Hammer-Aitoff, Plate Carrée) #
    rgb_func: Callable[..., Tuple] = bp_rp_to_rgb   # Coloring (i.e. BP-RP to RGB (temperature), )              #
